...
export const TenantDetails = ({
  ...
  // Initialize allowedCategories when manufacturer is selected
  React.useEffect(() => {
    if (
      tenantData.tenantType === "manufacturer" &&
      !tenantData.allowedCategories
    ) {
  ...
  const tenantTypes = [
    ...
    },
    {
      value: "architect",
      label: "Architect",
      description: "Design and architectural firms",
      icon: "📐",
    },
    {
      value: "home_owner",
      label: "Home Owner",
      description: "Individual property owners",
      icon: "🏠",
    },
  ];
  ...
  const handleAddCategory = (categoryId: string) => {
    if (!tenantData.allowedCategories?.includes(categoryId)) {
      setTenantData({
        ...tenantData,
        allowedCategories: [
          ...(tenantData.allowedCategories || []),
  ...
  const handleRemoveCategory = (categoryId: string) => {
    setTenantData({
      ...tenantData,
      allowedCategories:
        tenantData.allowedCategories?.filter((id) => id !== categoryId) || [],
    });
  };
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Let's start with the basic details of your organization
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setTenantData({ ...tenantData, slug: e.target.value })
            }
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"
            ...
            {tenantTypes.map((type) => (
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setTenantData({ ...tenantData, tenantType: e.target.value })
                  }
        ...
        {tenantData.tenantType === "manufacturer" && (
          <div>
            ...
            <p className="text-sm text-gray-600 mb-3">
              Select the product categories your organization manufactures
            </p>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                {availableCategories
                  .filter(
                    (cat) => !tenantData.allowedCategories?.includes(cat.id)
                  )
                  .map((cat) => (
              ...
              {tenantData.allowedCategories &&
                tenantData.allowedCategories.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {tenantData.allowedCategories.map((categoryId) => {
            ...
            {plans.map((plan) => (
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setTenantData({ ...tenantData, plan: e.target.value })
                  }
                  className="w-4 h-4 text-blue-600 hidden"
                />
