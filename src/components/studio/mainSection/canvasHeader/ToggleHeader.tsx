...
import { CanvasMode, setActiveTab, setCanvasType } from '@/hooks/slices/canvas/canvasSlice';
  ...
  return (
   <div className="flex items-center space-x-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className={`group relative flex items-center justify-start w-10 hover:w-20 transition-all duration-300 overflow-hidden px-2
                ${
                  activeCanvas === "mask"
                    ? "bg-blue-100 text-blue-600 border-blue-400"
                    : ""
